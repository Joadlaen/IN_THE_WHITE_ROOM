...
void ATPPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATPPCharacter::Look);
...
void ATPPCharacter::DoMove(float Right, float Forward)
{
...
void ATPPCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ATPPCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ATPPCharacter::DoJumpEnd()
{
